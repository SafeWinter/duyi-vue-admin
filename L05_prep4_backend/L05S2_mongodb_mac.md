# L05S2：Mongodb 数据库相关操作（基于 Mac OS）

本节录制时间：`2022-09-11 13:12`。

---



本节是后来专门针对 `MacOS` 下安装 `MongoDB` 数据库的补充课程，更新了当时已经过时的 `MongoDB` 客户端工具 `Robo 3T`（即现在的 `Studio 3T`）。学习笔记与原始课件保持原样。
...
<img src="../assets/5.14.png" alt="image-20220911132350349" style="zoom:50%;" />

会自动根据你的操作系统选择对应的版本。直接点击 download 进行下载即可。

<img src="../assets/5.15.png" alt="image-20220911132428555" style="zoom:50%;" />
...
<img src="../assets/5.16.png" alt="image-20220911132539327" style="zoom:50%;" />

需要大家创建几个文件：

<img src="../assets/5.17.png" alt="image-20220911132630299" style="zoom:50%;" />
...
<img src="../assets/5.18.png" alt="image-20220911133449422" style="zoom:50%;" />
...
<img src="../assets/5.19.png" alt="image-20220911133845128" style="zoom:50%;" />
...
<img src="../assets/5.20.png" alt="image-20220911134117344" style="zoom:50%;" />
...
<img src="../assets/5.21.png" alt="image-20220911135057011" style="zoom:50%;" />
...
<img src="../assets/5.22.png" alt="image-20220911135219396" style="zoom:50%;" />

接下来我们还是去官网，下载其他的可执行文件压缩包

<img src="../assets/5.23.png" alt="image-20220911135339189" style="zoom:50%;" />
...
<img src="../assets/5.24.png" alt="image-20220911141602788" style="zoom:50%;" />
...
<img src="../assets/5.25.png" alt="image-20220911141905213" style="zoom:50%;" />
...
<img src="../assets/5.26.png" alt="image-20220911142340068" style="zoom:50%;" />

通过可视化工具也可以看到我们数据恢复成功！

<img src="../assets/5.27.png" alt="image-20220911142452738" style="zoom:50%;" />
...
![image-20220911142632659](../assets/5.28.png)

真实的图片实际上是在服务器对应的目录下面

![image-20220911142733280](../assets/5.29.png)
